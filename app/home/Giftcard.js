          ...
          <ModalContent style={{ width: "100%", height: 200 }}>
            <View className="w-full">
              <View className="w-full p-2 rounded-lg">
                <Pressable className="w-full flex flex-row items-center mb-5" onPress={handleTakePhoto}>
                  <EvilIcons name="camera" size={36} color="black" />
                  <Text className="text-[16px] font-semibold mr-5">
                    Take a photo
                  </Text>
                </Pressable>
                <Pressable className="w-full flex flex-row items-center mb-2" onPress={handlePress}>
                  <EvilIcons name="camera" size={36} color="black" />
                  <Text className="text-[16px] font-semibold mr-5">
